...
const partialPipeline = await pipelinePrompt.partial({
    company_name: '星航科技',
    company_values: '「极致、开放、靠谱」的价值观',
    tone: '偏正式但不僵硬',
});

const partialFormatted = await partialPipeline.format({
    team_name: 'AI 平台组',
    company_name: '星航科技333',
    manager_name: '刘东',
...
const partialFormatted2 = await partialPipeline.format({
    team_name: 'AI 工程效率组',
    manager_name: '王强',
