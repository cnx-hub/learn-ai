...
/**
 * @typedef {Object} WeeklyPipelineInput
 * @property {string} tone
 * @property {string} company_name
 * @property {string} team_name
 * @property {string} manager_name
 * @property {string} week_range
 * @property {string} team_goal
 * @property {string} dev_activities
 * @property {string} company_values
 */
...
/**
 * 在 PipelinePromptTemplate 这一层覆写 format 入参类型：
 * 先去掉库里原始的宽签名，再替换为 WeeklyPipelineInput。
 * @type {Omit<typeof pipelinePrompt, 'format'> & {
 *   format(values: WeeklyPipelineInput): Promise<string>
 * }}
 */
const typedPipelinePrompt = pipelinePrompt;

const finalPrompt = await typedPipelinePrompt.format({
    tone: '专业、清晰、略带幽默',
    company_name: '星航科技',
    team_name: 'AI 平台组',
    manager_name: '王总',
